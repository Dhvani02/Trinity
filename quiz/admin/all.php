...
?>
    <div class="nav-wrapper green">
      ...
      <ul class="right hide-on-med-and-down">
	    ...
	    <li><a href="listpage.php"><i class="material-icons left">edit</i>Question List</a></li> 		
        <li><a href="logout.php"><i class="material-icons left">power_settings_new</i>Logout</a></li>		
		<?php
			}
			else
			{?>
		<li><a href="eventadd.php"><i class="material-icons left">add</i>Add Events</a></li>	  
        <li><a href="logout.php"><i class="material-icons left">power_settings_new</i>Logout</a></li>						
			<?php
			}
		}else{?>
      ...
      <ul class="side-nav" id="mobile-demo">
		...
		{
		?>
        <li><a href="eventadd.php"><i class="material-icons left">add box</i>Add Events</a></li>
        <li><a href="logout.php"><i class="material-icons left">power_settings_new</i>Logout</a></li>			
		<?php	
		}
		}
